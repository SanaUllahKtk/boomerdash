...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::controller(VideoController::class)->group(function () {
        ...
        Route::post('/videos/featured', 'updateFeatured')->name('videos.featured');
        Route::post('/videos/search', 'search')->name('videos.search');
        Route::get('/videos/excel/{id}', 'excelexpo')->name('videos.excel');
    });
    ...
    Route::controller(StoreController::class)->group(function () {
        ...
        Route::get('/edit/{id}', 'edit')->name('stores.edit');
        Route::post('/stores/{id}/updated', 'update')->name('stores.update');
        Route::delete('/stores/{id}', 'destroy')->name('stores.destroy');
    ...
    Route::controller(CustomerController::class)->group(function () {
        Route::post('paypal_form', 'paypal_form')->name('customers.paypal_form');
        Route::get('paypal_status/{id}', 'paypal_status')->name('customers.paypal_status');
        Route::get('pay_customer/{id}', 'pay_customer')->name('customers.pay_customer');
        Route::get('withdraw_history', 'withdraw_history')->name('customers.withdraw_history');
