...
@endphp
<a href="javascript:void(0)" class="d-flex align-items-center text-reset h-100 position-relative" data-toggle="dropdown"
    data-display="static">
    <i class="la la-gratipay la-2x opacity-80 header_user_icon"></i>
    <span class="flex-grow-1 ml-1">
        @if (isset($cart) && count($cart) > 0)
            <span class="badge badge-primary badge-inline badge-pill cart-count position-absolute" style="top:10%; right: 0">
                {{ count($cart) }}
            </span>
        @else
            <span class="badge badge-primary badge-inline badge-pill cart-count position-absolute" style="top:10%; right: 0">0</span>
        @endif
