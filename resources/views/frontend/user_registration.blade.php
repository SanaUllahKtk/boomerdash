                                ...
                                <div class="">
                                    ...
                                    <!-- <form id="reg-form" class="form-default" role="form" action="" method="POST"> -->
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" placeholder="{{  translate('Full Name') }}" required name="name">
                                            @if ($errors->has('name'))
                                        ...
                                        @if (addon_is_activated('otp_system'))
                                            <div class="form-group phone-form-group mb-1">
                                                <input type="tel" id="phone-code" required class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="" name="phone" autocomplete="off">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" required placeholder="{{  translate('Confirm Password') }}" name="password_confirmation">
                                        </div>
                                         <div class="row">
                                            <div class="col-md-12 mb-3">
                                               <input type="text" class="form-control" required placeholder="{{  translate('Phone') }}" name="phone">
                                            </div>
                                        </div>
                                               <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <p>Date of Birth</p>
                                               <input type="date" class="form-control" required placeholder="{{  translate('Date of Birth') }}" name="dob">
                                            </div>
                                        </div>
