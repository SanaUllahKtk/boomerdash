                    ...
                    <div class="row aiz-steps arrow-divider">
                        <div class="col active">
                            <div class="text-center text-primary">
                                <i class="la-3x mb-2 la la-gratipay"></i>
                        ...
                        <div class="col">
                            <div class="text-center">
                                ...
                                <h3 class="fs-14 fw-600 d-none d-lg-block opacity-50">{{ translate('2. Receipt') }}</h3>
                            </div>
                        </div>
                        <div class="col">
                            <div class="text-center">
                                            ...
                                            <div class="row gutters-5">
                                                ...
                                                <div class="col-lg col-6 order-4 order-lg-0">
                                                    @if ($cartItem['digital'] != 1 && $product->auction_product == 0)
                                                        <div
                                                            class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0" style="max-width:100px">
                                                            <button
                                ...
                                <div class="col-md-6 text-center text-md-right">
                                    @if (Auth::check())
                                        <a href="{{ route('checkout.shipping_info') }}" class="btn btn-primary fw-600">
                                            {{ translate('Upload Receipt') }}
                                        </a>
                                    @else
                                        <button class="btn btn-primary fw-600"
                                            onclick="showCheckoutModal()">{{ translate('Upload Receipt') }}</button>
                                    @endif
                                </div>
                            </div>
                        </div>
