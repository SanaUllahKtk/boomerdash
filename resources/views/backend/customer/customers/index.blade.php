                            ...
                            @if ($user != null)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @endif
                                        <a class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-deletes"
                                            href="{{ route('customers.destroy', $user->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Reward Point</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="{{ route('rewardPoints') }}" method="POST" id="PointForm">
                    @csrf
                    <div class="modal-body">

                        <div class="form-group">
                            <input type="number" required value="" name="points" placeholder="Enter Points"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="submitPointForm()" class="btn btn-primary">Save
                            changes</button>
                    </div>
                </form>
            </div>
