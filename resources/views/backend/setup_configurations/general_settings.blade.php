            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Description Recept')}}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="recp_desc">
                                <textarea  name="recp_desc" class="form-control">{{ get_setting('recp_desc') }}</textarea>
                            </div>
                        </div>
