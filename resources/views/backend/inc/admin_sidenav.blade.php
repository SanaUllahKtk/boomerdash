<div class="aiz-sidebar-wrap ">
    <div class="aiz-sidebar left c-scrollbar " >
        <div class="aiz-side-nav-logo-wrap">
            <!--style="background: linear-gradient(90deg, rgba(125,37,140,1) 12%, rgba(38,99,242,1) 32%, rgba(54,115,255,1) 42%, rgba(250,237,46,1) 66%, rgba(245,153,41,1) 81%, rgba(217,36,37,1) 99%);"-->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.withdraw_history') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Customer Withdraw') }}</span>
                                </a>
                            </li>
