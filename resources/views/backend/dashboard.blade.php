...
<div class="row gutters-10">
    <div class="col-lg-6">
        <div class="row gutters-10">
            ...
            <div class="col-6">
                <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden" style="background: linear-gradient(90deg, rgba(125,37,140,1) 12%, rgba(38,99,242,1) 32%, rgba(54,115,255,1) 42%, rgba(250,237,46,1) 66%, rgba(245,153,41,1) 81%, rgba(217,36,37,1) 99%);">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ translate('Total') }}</span>
