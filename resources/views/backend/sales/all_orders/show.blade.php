        ...
        <div class="card-body">
            <div class="row gutters-5">
                ...
                @php
                    ...
                    $payment_status = $order->rejection;
                @endphp
                ...
                <div class="col-md-3 ml-auto">
                    <label for="update_payment_status">{{ translate('Rejection Reasons') }}</label>
                    <select class="form-control aiz-selectpicker" data-minimum-results-for-search="Infinity"
                        id="update_payment_status">
                        
                        <option value="invalid" @if ($payment_status == 'invalid') selected @endif>{{ translate('Invalid Receipt') }}
                        </option>
                        <option value="duplicate" @if ($payment_status == 'duplicate') selected @endif>{{ translate('Duplicate Receipt') }}
                        <option value="unqualified " @if ($payment_status == 'unqualified ') selected @endif>{{ translate('Unqualified Receipt') }}
                        </option>
                    </select>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if ($delivery_status == 'confirmed')
                                        <span
                                            class="badge badge-inline badge-success">Completed</span>
                                    @endif
            ...
            <div class="row">
            <div class="col-lg-4">
                <img src="{{$order->recept}}" style="width: 100%;">
                </div>
                ...
                <div class="col-lg-6">
                    <form action="{{ route('savepoints') }}" class="form-default" role="form" method="POST"
                        id="checkout-form" enctype="multipart/form-data">
                          @csrf
                        <input type="hidden" name="order_id" value="{{$order->id}}">
                        <input type="hidden" name="user_id" value="{{$order->user->id}}">
                        <input type="text" name='points' class="form-control" placeholder="Enter the points">
