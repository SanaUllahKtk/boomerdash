        ...
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Product Points')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Product Points') }}" name="unit_price" class="form-control" required>
                            </div>
                        </div>
