...
@section('content')
    ...
    <div class="">
        <form class="form form-horizontal mar-top" action="{{ route('stores.store') }}" method="POST"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Store Name') }} <span
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Cashback') }} <span
                                class="text-danger">*</span></label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="cashback"
                                placeholder="{{ translate('Cashback') }}" required>
                        </div>
                    </div>
                </div>
