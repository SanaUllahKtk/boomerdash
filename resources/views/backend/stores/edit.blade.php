...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('stores.update', $store->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
        @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="name" value="{{ $store->name ?? ''}}" placeholder="{{ translate('Store Name') }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="cashback" value="{{ $store->cashback ?? ''}}" placeholder="{{ translate('Cashback') }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="url" value="{{ $store->url ?? ''}}" placeholder="{{ translate('Url') }}" required>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                            ...
                            <input type="hidden" name="photos" value="{{ $store->logo }}" class="selected-files">
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <textarea class="aiz-text-editor" name="description">{{ $store->description }}</textarea>
                    </div>
                </div>
            </div>
        </div>
