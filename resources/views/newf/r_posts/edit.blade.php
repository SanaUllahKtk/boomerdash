                ...
                <div class="col-md-9">
                    <div class="aiz-user-panel">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('r_mobile_posts.update', ['r_mobile_post' => $r_post]) }}"
                                    id="post-form">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="brandId" id="brandId"
                                                ...
                                                @foreach ($brands as $key => $brand)
                                                    <option value="{{ $key }}"
                                                        @if (old('brandId', $r_post->brandId) == $key) selected @endif>
                                                        {{ $brand }}</option>
                                                @endforeach
                                            </select>
                                            @error('brandId')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="productId" id="productId"
                                                ...
                                                @foreach ($products as $key => $product)
                                                    <option value="{{ $key }}"
                                                        @if (old('productId', $r_post->productId) == $key) selected @endif>
                                                        {{ $product }}</option>
                                                @endforeach
                                            </select>
                                            @error('productId')
                                        ...
                                        <div class="col-md-6 d-none">
                                            ...
                                            <select name="categoryId" id="category"
                                                ...
                                                @foreach ($categories as $key => $category)
                                                    <option value="{{ $key }}"
                                                        @if (old('categoryId', $r_post->r_category_id) == $key) selected @endif>
                                                        {{ $category }}
                                                    </option>
                                                @endforeach
                                            </select>
