...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($seller_products as $seller_product) {
                        ...
                        $files = $request->file('recept');
                        $rot=$request->root().'/public/recept/';
                        $t=time();
                        $imgs = $rot.$t.$files->getClientOriginalName();
                        $files->move(public_path('recept'),  $t.$files->getClientOriginalName());
    ...
    public function update_delivery_status(Request $request)
    {
        ...
        // foreach($combined_order->orders as $order){
            NotificationUtility::sendOrderStatusNotification($order);
        // }
   ...
   public function update_tracking_code(Request $request) {
    ...
    {
        $order = Order::findOrFail($request->order_id);
        $order->rejection = $request->status;
        $order->save();
