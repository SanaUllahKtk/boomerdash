...
class CartController extends Controller
{
    ...
    public function carts_summary(Request $request)
    {
        if(auth()->user() != null) {
            $user_id = Auth::user()->id;
            if($request->session()->get('temp_user_id')) {
        ...
        return view('frontend.carts_summary', compact('carts'));
    }
    ...
    public function addToCart(Request $request)
    {
        ...
        if(auth()->user() != null) {
            ...
            if($request->session()->get('temp_user_id')) {
                ...
                $temp_user_id = bin2hex(random_bytes(11));
        ...
        if($product->auction_product == 0){
			...
			$pro_id=$request->id;
			$cat_id= Product::where('id', $pro_id)->first()->category_id;
               return array(
                'status' => 1,
                'cart_count' => count($carts),
                'cart_view' => view('frontend.partials.cart_details', compact('carts'))->render(),
