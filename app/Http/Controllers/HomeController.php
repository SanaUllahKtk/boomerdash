...
class HomeController extends Controller
{
    ...
    public function dashboard()
    {
        if (Auth::user()->user_type == 'seller') {
            ...
            return view('frontend.user.customer.dashboard', compact('products'));
    ...
    {
        return view('newf.about');
    }
    public function contact()
    {
        return view('newf.contact');
    }
    public function termscon()
    {
        return view('newf.terms');
    }
    public function privacy()
    {
        return view('newf.policy');
    }
    ...
    public function inhouse_products(Request $request)
    {
        ...
        {
            flash(translate("You don't have sufficient balance for request"))->error();
            return back();
        }
        else{
        $user = new Withdrawal();
        ...
        $wallet = User::findOrFail($request->userid);
        $wallet->balance = $wallet->balance - $request->amount;
        $wallet->save();
        
            flash(translate('Withdrawal Request has been sent to admin.'))->success();
            return back();
        }
