...
class CategoryController extends Controller
{
     ...
     public function destroy($id)
    {
        try {
            ...
            // Perform any additional checks or validation here, if needed

            $category->delete(); // Delete the category

            // You can return a response indicating success if desired
            ...
            flash(translate('Category has not been deleted successfully'))->error();
            return back();
        }
    }
